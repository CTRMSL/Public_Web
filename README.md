...
- 🟢 **Picker (start here):** https://ctrmsl.github.io/Public_Web/
- **Version A — Premium Dark Enterprise (recommended)** · https://ctrmsl.github.io/Public_Web/v/a/
...
```
/
  index.html                          ← picker landing (this is what most visitors hit first)
  previews/                           ← thumbnails used by the picker
  v/
...
| Letter | Style | What's distinctive |
|---|---|---|
| **A** | Premium Dark Enterprise | Dark navy + electric-blue accents, real product UI in macOS device frames, full landing structure, 30-sec demo video wired to the "Watch Demo" / "Watch Walkthrough" buttons. **This is the recommended direction.** |
...
VIGILO is positioned as a **Financial Intelligence Platform** for the **three lines of assurance, across industries** — Statutory & Internal Auditors, CRO & Risk Management, CFOs & Executives.
...
The internal repository with full design strategy, source assets, and documentation lives at https://github.com/CTRMSL/CTR_Web (private).
